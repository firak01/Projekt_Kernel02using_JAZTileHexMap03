		...
		main:{
			try {				
				...
				for(TroopArmy objArmy : list02){
					...
					//20180214: Versuche hier eine "berechnete" Spalte auszugeben, die mit @Formula "zur Laufzeit" erstellt wird.
					System.out.println("Gefundene (zur Laufzeit errechnete Formelspalte) UniqueDate: " + objArmy.getUniqueDate());
				}
