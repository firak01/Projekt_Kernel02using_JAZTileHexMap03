...
import basic.zBasic.persistence.hibernate.HibernateSessionFactoryTomcatFactoryZZZ;
 ...
 *
 */
public class HibernateSessionFactoryTomcatFactoryJndiTHM  extends HibernateSessionFactoryTomcatFactoryZZZ{
...
//Merke 20171225: Anders als bei den "normalen SessionFactories" kann bei JNDI die HibernateSessionFactoryTomcatFactoryZZZ nicht erweitert werden.
	            //Es kommt dann nämlich zu folgender Fehlermeldung:
	            //Caused by: java.lang.ClassCastException: org.apache.naming.ResourceLinkRef cannot be cast to org.hibernate.SessionFactory
	            //Also leider hier Redundanz ertragen...
	            //TODO: Wenn man schon auf die Methode getObjectInstance(...) nicht verzichten kann, dann wäre es schön, wenn man den Inhalt der Methode
	            //      irgendeiner Utility-Klasse aufrücken könnt.
...
//	}
	...
	//### Aus Interface implementierte Methoden	
	public IHibernateContextProviderZZZ getHibernateContextProvider() throws ExceptionZZZ {
		return HibernateContextProviderJndiSingletonTHM.getInstance();
	}  
	}  
