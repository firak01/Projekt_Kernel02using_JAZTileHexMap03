...
public class DebugTileImmutabletextDao {
	...
	public static void main(String[] args) {
		...
		main:{
			try{
				...
				DebugTileImmutabletextDao objDebug = new DebugTileImmutabletextDao();	
	...
	public DebugTileImmutabletextDao(){		
	}
...
//				}
				...
				sKeytype = "IMMUTABLETILETEXT";
				Immutabletext objKey02 = (Immutabletext) daoKey.searchKey(sKeytype, lngThiskey );
				if(objKey02==null){
	...
	public boolean debugFindAll(){
		...
		main:{
			try {				
				...
				TileImmutabletextDao daoKey = new TileImmutabletextDao(objContextHibernate);				
				String sKeytype = new String("IMMUTABLETILETEXT");		
				Long lngThiskey = new Long(1);

				TileImmutabletext objKey02 = (TileImmutabletext) daoKey.searchKey(sKeytype, lngThiskey );
				if(objKey02==null){
					System.out.println("2. Abfrage: UNERWARTETES ERGEBNIS. Kein Key mit dem KeyType '" + sKeytype + "' und dem Thiskey '" + lngThiskey.toString() + "' gefunden.");
				}else{
					System.out.println("2. Abfrage: Erwartetes Ergebnis. Key mit dem KeyType '" + sKeytype + "' und dem Thiskey '" + lngThiskey.toString() + "' gefunden.");			
					...
					//Nun alle holen
					ArrayList<TileImmutabletext> listaTileDefaulttext = (ArrayList<TileImmutabletext>) daoKey.findLazyAll();
					for(TileImmutabletext text : listaTileDefaulttext){
						System.out.println("TileImmutbletext.toString(): " + text.toString());
//						String sTYPE = "ARMY";
