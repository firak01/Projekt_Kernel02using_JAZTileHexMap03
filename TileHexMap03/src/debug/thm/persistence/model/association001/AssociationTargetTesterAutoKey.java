...
public class AssociationTargetTesterAutoKey implements Serializable, IOptimisticLocking{
	...
	public String getDummyString(){
	 ...
	 @Id				
	 @TableGenerator(name="lidGeneratorAssociationTarget", table="COMMON_FUER_IDGENERATOR_ASSOCIATIONTARGET",pkColumnName="nutzende_Klasse_als_String", pkColumnValue="SequenceTester",valueColumnName="naechster_id_wert",  initialValue=1, allocationSize=1)
	 @GeneratedValue(strategy = GenerationType.TABLE, generator="lidGeneratorAssociationTarget")
