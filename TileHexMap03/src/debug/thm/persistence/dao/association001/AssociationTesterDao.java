...
public class AssociationTesterDao extends GeneralDaoZZZ<AssociationTester> {
	...
	public AssociationTesterDao(HibernateContextProviderTHM objContextHibernate) throws ExceptionZZZ{
		super(objContextHibernate);		
		this.installLoger(AssociationTester.class);
	}
	public AssociationTesterDao(HibernateContextProviderTHM objContextHibernate, String sFlagControl) throws ExceptionZZZ{
		super(objContextHibernate, sFlagControl);
		this.installLoger(AssociationTester.class);
	}
	public AssociationTesterDao(HibernateContextProviderTHM objContextHibernate, String[] saFlagControl) throws ExceptionZZZ{
